defmodule EctoPlaylistTest do
  ...
  test "ordered_items_list/2" do
    assert EctoPlaylist.ordered_items_list(@all_items, [5, 3, 1]) ==
             [
               %{id: 5, title: "Item 5", inserted_at: ~N[2019-07-16 16:07:15]},
               %{id: 3, title: "Item 3", inserted_at: ~N[2019-07-16 16:05:15]},
               %{id: 1, title: "Item 1", inserted_at: ~N[2019-07-16 16:03:15]},
  ...
  test "ordered_items_list/2 when item missing" do
    ...
    assert EctoPlaylist.ordered_items_list(all_items_1, [5, 3, 1]) ==
             [
               %{id: 5, title: "Item 5", inserted_at: ~N[2019-07-16 16:07:15]},
               %{id: 1, title: "Item 1", inserted_at: ~N[2019-07-16 16:03:15]},
               %{id: 2, title: "Item 2", inserted_at: ~N[2019-07-16 16:04:15]},
  ...
  test "complete_order/2" do
    assert EctoPlaylist.complete_order(@all_items, [5, 3, 1]) ==
             [5, 3, 1, 2, 4]
  end

  test "complete_order/2 when nil" do
    assert EctoPlaylist.complete_order(@all_items, nil) ==
             [1, 2, 3, 4, 5]
  end

  test "complete_order/2 when items order = []" do
    assert EctoPlaylist.complete_order(@all_items, []) ==
             [1, 2, 3, 4, 5]
  end

  test "missing_ids_list/1" do
    assert EctoPlaylist.missing_ids_list(@all_items) == [1, 2, 3, 4, 5]
  end

  test "missing_ids_list/2" do
    assert EctoPlaylist.missing_ids_list(@all_items, [5, 3, 1]) == [2, 4]
  end
